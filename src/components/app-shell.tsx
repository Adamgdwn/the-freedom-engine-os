  ...
  return (
    <div className="mx-auto flex min-h-screen w-full max-w-[1600px] flex-col gap-6 px-4 py-5 lg:flex-row lg:px-6">
      <aside className="panel h-fit rounded-[2rem] border border-white/60 p-5 lg:sticky lg:top-6 lg:w-[300px]">
        ...
        <div className="mt-6 rounded-[1.75rem] border border-[color:var(--line)] bg-white/75 p-4">
          ...
          <p className="mt-2 text-sm leading-6 text-[color:var(--ink)]">
            Create more time sovereignty, family capacity, financial resilience, and value creation
            than extraction.
          </p>
        </div>

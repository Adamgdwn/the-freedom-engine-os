...
| R-006 | Mobile companion access broadens the trust boundary around workspace control | Medium | High | Reuse Adam Connect approved roots, local Codex auth, Tailscale/private networking, and explicit phone pairing | Adam Goodwin | Open |

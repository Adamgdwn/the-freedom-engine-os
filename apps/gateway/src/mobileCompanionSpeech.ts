...
export function readSpeechTextHeader(rawHeaders: Record<string, string | string[] | undefined>): string {
...
export function readSpeechVoiceProfileHeader(rawHeaders: Record<string, string | string[] | undefined>): MobileCompanionSpeechVoiceProfile {
